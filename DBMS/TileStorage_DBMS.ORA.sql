...
create table Z_CONTENTTYPE (
   ...
   contenttype_text     varchar2(50)                   not null,
...
create table Z_OPTIONS (
   id_option            NUMBER(10)                     not null,
   option_descript      varchar2(255)                  not null,
   option_value         NUMBER(10)                     not null,
...
create table Z_DIV_MODE (
   ...
   div_mode_name        varchar2(30)                   not null,
   div_mask_width       NUMBER(5)                      not null,
...
create table Z_VER_COMP (
   ...
   ver_comp_field       varchar2(30)                   not null,
   ver_comp_name        varchar2(30)                   not null,
...
create table Z_SERVICE (
   ...
   tile_load_mode       NUMBER(5)                      default 0 not null,
   tile_save_mode       NUMBER(5)                      default 0 not null,
   tile_hash_mode       NUMBER(5)                      default 0 not null,
   ver_by_tile_mode     NUMBER(5)                      default 0 not null,
...
create table Z_VER_BY_TILE (
   id_ver_by_tile       NUMBER(5)                      not null,
   tile_contenttype     NUMBER(5)                      not null,
   src_parser           varchar2(255)                  not null,
   src_desc             varchar2(255)                  null,
   src_catalog          varchar2(255)                  null,
   src_root             varchar2(63)                   null,
   src_name             varchar2(63)                   null,
   ...
   auxillary_ver        NUMBER(5)                      null,
   auxillary_dat        TIMESTAMP                      null,
   auxillary_num        NUMBER(10)                     null,
