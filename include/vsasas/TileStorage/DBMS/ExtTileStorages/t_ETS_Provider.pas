...
type
  ...
  // replace tile version (supported by provider)
  // name 'ETS_SetTileVersion' (OPTIONAL)
  TETS_SetTileVersion = function(
    const AProvider_Handle: PETS_Provider_Handle;
...
const
  ...
  ETS_INFOCLASS_SetZLibCompression    = $02; // set transparent zlib compression mode
